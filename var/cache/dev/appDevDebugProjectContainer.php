...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'firebase_chat.fbrealtimedb' => 'getFirebaseChat_FbrealtimedbService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('nrHNU6lHiN', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-9Gf-qKJ5C', 0, '3m8AiL4zZVboTxJ5OBlzgA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FKD5qrxUOv', 0, '3m8AiL4zZVboTxJ5OBlzgA', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FVMPmV7fVT', 0, '3m8AiL4zZVboTxJ5OBlzgA', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'firebase_chat', 'user' => 'firebase_chat', 'password' => 'fb_chat', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9d36836d4d274e85dffedd7063a2341250910e0f43b2afa33edf23033282f6e0');
    ...
    /**
     * Gets the 'firebase_chat.fbrealtimedb' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FirebaseChat\Helper\FirebaseRealtimeDb A FirebaseChat\Helper\FirebaseRealtimeDb instance
     */
    protected function getFirebaseChat_FbrealtimedbService()
    {
        return $this->services['firebase_chat.fbrealtimedb'] = new \FirebaseChat\Helper\FirebaseRealtimeDb('https://fir-chat-test-4e6af.firebaseio.com/', 'MTZLqIxMdoJqLhiOoJVNU7YBPbrQ17TLWD1dKHkN', '/chat');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a3a7f93ad119d858c18b380b0c555fcd917c7a13');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58209ec9950580.44292606')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'firebase_chat',
            'database_user' => 'firebase_chat',
            'database_password' => 'fb_chat',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'a3a7f93ad119d858c18b380b0c555fcd917c7a13',
            'firebase_app_url' => 'https://fir-chat-test-4e6af.firebaseio.com/',
            'firebase_chat_db_path' => '/chat',
            'firebase_auth_token' => 'MTZLqIxMdoJqLhiOoJVNU7YBPbrQ17TLWD1dKHkN',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'a3a7f93ad119d858c18b380b0c555fcd917c7a13',
            ...
            'firebase_chat.firebase_config.app_url' => 'https://fir-chat-test-4e6af.firebaseio.com/',
            'firebase_chat.firebase_config.auth_token' => 'MTZLqIxMdoJqLhiOoJVNU7YBPbrQ17TLWD1dKHkN',
            'firebase_chat.firebase_config.chat_db_path' => '/chat',
